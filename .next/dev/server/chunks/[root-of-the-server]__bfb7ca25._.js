...
"[project]/OOAD Project/app/api/quizzes/submissions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://hippmmotshyilrbrvwmh.supabase.co"), process.env.SUPABASE_SERVICE_ROLE_KEY);
...
async function GET(request) {
    try {
        ...
        let quiz = __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["quizzesStore"].get(quizId);
        if (!quiz) {
            try {
                const quizResult = await __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$node_modules$2f40$vercel$2f$postgres$2f$dist$2f$chunk$2d$7IR77QAQ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sql"]`
        ...
        let attempts = Array.from(__TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["quizAttemptsStore"].values()).filter((attempt)=>attempt.quiz_id === quizId && attempt.finished_at);
        ...
        let dbAttempts = [];
        try {
            const dbResult = await __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$node_modules$2f40$vercel$2f$postgres$2f$dist$2f$chunk$2d$7IR77QAQ$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sql"]`
      ...
      `;
        ...
        const attemptsWithEmails = await Promise.all(allAttempts.map(async (attempt)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bfb7ca25._.js.map