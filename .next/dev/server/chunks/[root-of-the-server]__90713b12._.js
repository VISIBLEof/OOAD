...
"[project]/OOAD Project/app/api/assignments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
      ...
      `;
            ...
            const assignments = Array.from(__TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignmentsStore"].values());
            if (courseId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: true,
                    data: assignments.filter((a)=>a.course_id === courseId)
                });
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
...
async function POST(request) {
    try {
        ...
        `;
            ...
            const course = __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coursesStore"].get(courseId);
      ...
      `;
            ...
            const assignmentId = `assignment_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementAssignmentId"])()}`;
            const assignment = {
                id: assignmentId,
                course_id: courseId,
                title,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignmentsStore"].set(assignmentId, assignment);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveAssignments"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90713b12._.js.map