...
function calculateScore(questions, answers) {
    ...
    questions.forEach((question, index)=>{
        ...
        if (question.type === 'single' || question.type === 'multi') {
            if (JSON.stringify(studentAnswer) === JSON.stringify(question.correct_answer)) {
                score += 100;
            }
        }
    });
...
async function POST(request, { params }) {
    ...
    `;
      ...
      SET answers = ${JSON.stringify(answers)}, score = ${score}, finished_at = NOW()
      WHERE id = ${attemptId} AND student_id = ${user.userId}
      RETURNING id, quiz_id, student_id, score, finished_at
    `;
        return __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06db91a1._.js.map