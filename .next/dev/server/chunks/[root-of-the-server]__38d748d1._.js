...
async function POST(request, { params }) {
    ...
    `;
        ...
        // Get quiz to include time limit
      ...
      SELECT time_limit_minutes FROM quizzes WHERE id = ${id}
    `;
        return __TURBOPACK__imported__module__$5b$project$5d2f$OOAD__Project$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
                ...
                timeLimitMinutes: quizResult.rows[0].time_limit_minutes
            }
        }, {
            status: 201
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38d748d1._.js.map